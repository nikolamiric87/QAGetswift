...
class DestinationRequest extends _events.EventEmitter {
  ...
  _resendWithCredentials(res) {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this.credentialsSent = true; // NOTE: NTLM authentication requires using the same socket for the "negotiate" and "authenticate" requests.
  ...
  _isSocketHangUpErr(err) {
    return err.message && SOCKET_HANG_UP_ERR_RE.test(err.message) && // NOTE: Only for nodejs 4 error with a same message will be generated for different cases.
