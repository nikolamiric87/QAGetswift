...
class RequestPipelineContext {
  constructor(req, res, serverInfo) {
    ...
    this.requestId = (0, _generateUniqueId.default)();
  ...
  dispatch(openSessions) {
    ...
    const flattenParsedReferer = RequestPipelineContext._flattenParsedProxyUrl(parsedReferer); // NOTE: Try to extract the destination from the 'referer' header.
    ...
    this.dest = flattenParsedReqUrl.dest; // Browsers add a leading slash to the pathname part of url (GH-608)
