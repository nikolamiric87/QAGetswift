...
exports.HTTPS_DEFAULT_PORT = exports.HTTP_DEFAULT_PORT = exports.SPECIAL_PAGES = exports.TRAILING_SLASH_RE = exports.REQUEST_DESCRIPTOR_VALUES_SEPARATOR = exports.HASH_RE = exports.SUPPORTED_PROTOCOL_RE = void 0;
...
const SPECIAL_PAGES = ['about:blank', 'about:error'];
...
function parseProxyUrl(proxyUrl) {
  ...
  const destUrl = match[2]; // Browser can redirect to a special page with hash (GH-1671)
