...
class PageProcessor extends _resourceProcessorBase.default {
  constructor() {
    super();
    this.parser = new _parse.default.Parser();
    ...
    this.serializer = new _parse.default.Serializer();
  }
  ...
  processResource(html, _ctx, _charset, urlReplacer, processingOpts) {
    ...
    if (metas && _charset.fromMeta(PageProcessor._getPageMetas(metas, domAdapter))) return this.RESTART_PROCESSING;
    ...
    if (!_ctx.isHtmlImport) {
      ...
      if (_ctx.restoringStorages && !processingOpts.isIframe) this._addRestoreStoragesScript(_ctx, head);
    }
