...
var _locationPropertyGet = _interopRequireDefault(require("./location-property-get"));
...
const TRANSFORMERS = [_computedPropertyGet.default, _computedPropertySet.default, _concatOperator.default, _eval.default, _evalBind.default, _evalCallApply.default, _evalGet.default, _windowEvalGet.default, _postMessageGet.default, _windowPostMessageGet.default, _postMessageCallApplyBind.default, _forIn.default, _locationGet.default, _locationPropertyGet.default, _locationSet.default, _propertyGet.default, _propertySet.default, _methodCall.default, _jsProtocolLastExpression.default];

function createTransformerMap() {
  const transformerMap = new Map();
  var _arr = TRANSFORMERS;

  for (var _i = 0; _i < _arr.length; _i++) {
    const transformer = _arr[_i];
    const nodeType = transformer.nodeTypes;
    if (!transformerMap.has(nodeType)) transformerMap.set(nodeType, []);
