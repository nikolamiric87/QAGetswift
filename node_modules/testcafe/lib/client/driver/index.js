					...
					"driver.js": function (exports, module, require) {
						...
						var Driver = function () {
						    function Driver(testRunId, communicationUrls, runInfo, options) {
						        ...
						        this.setCustomCommandHandlers(_type2.default.unlockPage, function () {
						            return _this._unlockPageAfterTestIsDone();
						        });
						    }
						    ...
						    Driver.prototype._unlockPageAfterTestIsDone = function _unlockPageAfterTestIsDone() {
						        (0, _testcafeCore.disableRealEventsPreventing)();
						    ...
						    Driver.prototype._onExecuteSelectorCommand = function _onExecuteSelectorCommand(command) {
						        ...
						        var elementNotFoundOrNotVisible = function elementNotFoundOrNotVisible(fn) {
						            return new _testRun.CannotObtainInfoForElementSpecifiedBySelectorError(null, fn);
						        };
